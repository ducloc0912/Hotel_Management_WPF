...
{
    public partial class PRN212_ProjectContext : DbContext
    {
        public PRN212_ProjectContext()
        {
        }

        public PRN212_ProjectContext(DbContextOptions<PRN212_ProjectContext> options)
            : base(options)
        {
        }
